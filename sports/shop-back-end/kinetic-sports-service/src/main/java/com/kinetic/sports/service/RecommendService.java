...
public interface RecommendService {
    ...
    RecommendHomeVO recommendHome(Long userId, Integer courseLimit, Integer prodLimit);

    List<RecommendItemVO> recommendCourses(Long userId, Integer type, Long categoryId, Long currentCourseId, Integer limit);

    List<RecommendItemVO> recommendProducts(Long userId, Long categoryId, Long currentProdId, Integer limit);
}
